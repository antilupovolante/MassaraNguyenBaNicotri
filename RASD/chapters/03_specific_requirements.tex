...
\begin{longtable}{|c|l|}
    ...
    R13 \label{R.13}& The system must notify via email students when a tournament they subscribed to ends. \\ \hline
    ...
    R42 \label{R.42}& The system must notify via email students when their work has been manually evaluated. \\ \hline
